...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen  w-fit flex items-center justify-center py-8 px-3 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y- bg-white p-8 rounded-lg shadow-lg">
